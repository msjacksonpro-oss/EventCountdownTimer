    ...
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', color: '#a5b4fc', fontSize: '0.775rem', fontWeight: '700', marginBottom: '0.4rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
